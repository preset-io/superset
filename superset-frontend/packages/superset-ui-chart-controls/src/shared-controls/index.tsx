...
const sharedControls = {
  metrics: dnd_adhoc_metrics,
  metric: dnd_adhoc_metric,
  datasource: datasourceControl,
  viz_type,
  color_picker,
  metric_2: dnd_adhoc_metric_2,
  linear_color_scheme,
  secondary_metric: dnd_secondary_metric,
  groupby: dndGroupByControl,
  columns: dndColumnsControl,
  granularity,
  granularity_sqla: dnd_granularity_sqla,
  time_grain_sqla,
  time_range,
  row_limit,
  limit,
  timeseries_limit_metric: dnd_sort_by,
  orderby: dnd_sort_by,
  order_desc,
  series: dndSeries,
  entity: dndEntity,
  ...
  y_axis_format,
  x_axis_time_format,
  adhoc_filters: dnd_adhoc_filters,
  color_scheme,
  series_columns: dndColumnsControl,
  series_limit,
  series_limit_metric: dnd_sort_by,
  legacy_order_by: dnd_sort_by,
  truncate_metric,
  x_axis: dnd_x_axis,
  show_empty_columns,
};
