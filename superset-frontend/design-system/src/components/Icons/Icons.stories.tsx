...
export default {
  title: 'Design System/Foundations/Icons/Icon Listing',
  component: Icon,
};
...
`;
/*
export const SingleIconExample = ({
  iconName,
  iconColor,
  iconSize,
}: IconType & { iconName: string }) => {
  // The Icon's name is used to lookup an instance of an icon component with a specificed internal SVG
  const Icon = Icons[iconName];
  // Optionally set the icon's color and size
  return <Icon iconColor={iconColor} iconSize={iconSize} />;
};

SingleIconExample.argTypes = {
  iconName: {
    defaultValue: 'AlertSolid',
  },
  iconSize: {
    defaultValue: 'xl',
...
export const InteractiveIcons = ({
  ...
  <div>
    <p>Icons are cool</p>
    <p>The full set of icons provided by the design system are listed below:</p>
    <IconSet>
